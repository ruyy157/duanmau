                    ...
                    <?php
                        ...
                        <div class="menu-item style-four mb-30 wow fadeInUp">
                            ...
                            <a href="index.php?act=chitietsanpham">
                                <img src="'.$hinhanh.'" alt="Image" style="width: 100%; height: 350px;"></a>
                            ...
                            <div class="menu-info">
                                <div class="menu-meta">
                                    <span class="price"><span class="currency">$</span>'.$giasp.'</span>
                                    <span class="rating"><i class="fas fa-star"></i><a href="#">Số lượng còn :'.$soluong.'</a></span>
                                </div>
                                <h4 class="title"><a href="index.php?act=chitietsanpham">'.$tensp.'</a></h4>
                                <ul class="check-list style-one">
                                    <li><i class="far fa-check-circle"></i>'.$mota.'</li>
