                            ...
                            <div class="foodix-nav-menu">
                                ...
                                <nav class="main-menu">
                                    <ul>
                                        ...
                                        <li class="menu-item has-children"><a href="index.php?act=trangsp">Menu</a>
                                        ...
                                        <li class="menu-item has-children"><a href="#">Tài khoản</a>
                                            <ul class="sub-menu">
                                                <li><a href="blog-grid.html">Đăng kí</a></li>
                                                <li><a href="blog-classic.html">Đăng nhập</a></li>
                                ...
                                <div class="nav-button mt-50 d-block d-xl-none  text-center">
                                    <a href="contact.html" class="theme-btn style-one">Đặt bàn</a>
                                </div>
                            </div>
                            <!--=== Nav Right Item ===-->
