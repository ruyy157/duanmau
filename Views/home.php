                    ...
                    foreach ($dsdm as $dm){
                        ...
                        echo'
                                ...
                                <div class="col-xl-3 col-md-6 col-sm-12">
                                    <!--=== Category Item ===-->
                                    <a href="menu-v3.html" class="iconic-box style-four mb-40 wow fadeInUp">
                                       
                                        <div class="content">
                                            <h4 class="title">'.$tendanhmuc.'</h4>
                                            <!--======  còn thiếu a href $linkdm trong h4 ======-->
                                            <span>Nhiều mặt hàng</span>
                                        </div>
                                    </a>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="menu-item style-eight mb-30 wow fadeInUp">
                            <div class="menu-thumbmail">
                                <img src="assets/images/menu/menu-thumb1.png" alt="Menu Thumbnail">
                            </div>
                            <div class="menu-content-wrap">
                                <div class="content">
                                    <h4 class="title"><a href="menu-details.html">Truffle Mac và phô mai</a></h4>
                                    <p>
                                    Mac và phô mai thơm ngon với tinh chất nấm truffle.</p>
                                </div>
                                <div class="price-box">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="menu-item style-eight mb-30 wow fadeInUp">
                            <div class="menu-thumbmail">
                                <img src="assets/images/menu/menu-thumb2.png" alt="Menu Thumbnail">
                            </div>
                            <div class="menu-content-wrap">
                                <div class="content">
                                    <h4 class="title"><a href="menu-details.html">Bít tết Ribeye nướng
                                    </a></h4>
                                    <p>
                                    Món bít tết sườn nướng hoàn hảo với gia vị thơm ngon.</p>
                                </div>
                                <div class="price-box">
                                    <p class="price">$25.50</p>
                                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="menu-item style-eight mb-30 wow fadeInUp">
                            <div class="menu-thumbmail">
                                <img src="assets/images/menu/menu-thumb3.png" alt="Menu Thumbnail">
                            </div>
                            <div class="menu-content-wrap">
                                <div class="content">
                                    <h4 class="title"><a href="menu-details.html">Cá hồi tráng mật ong</a></h4>
                                    <p>Phi lê cá hồi tẩm mật ong ngọt và mặn.</p>
                                </div>
                                <div class="price-box">
                                    <p class="price">$25.50</p>
                                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="menu-item style-eight mb-30 wow fadeInUp">
                            <div class="menu-thumbmail">
                                <img src="assets/images/menu/menu-thumb4.png" alt="Menu Thumbnail">
                            </div>
                            <div class="menu-content-wrap">
                                <div class="content">
                                    <h4 class="title"><a href="menu-details.html">Thai Coconut Curry</a></h4>
                                    <p>Fragrant Thai coconut curry with vibrant vegetables.</p>
                                </div>
                                <div class="price-box">
                                    <p class="price">$25.50</p>
                                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="menu-item style-eight mb-30 wow fadeInUp">
                            <div class="menu-thumbmail">
                                <img src="assets/images/menu/menu-thumb5.png" alt="Menu Thumbnail">
                            </div>
                            <div class="menu-content-wrap">
                                <div class="content">
                                    <h4 class="title"><a href="menu-details.html">Gourmet Mushroom Risotto</a></h4>
                                    <p>Rich, creamy risotto with gourmet mushrooms</p>
                                </div>
                                <div class="price-box">
                                    <p class="price">$25.50</p>
                                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="menu-item style-eight mb-30 wow fadeInUp">
                            <div class="menu-thumbmail">
                                <img src="assets/images/menu/menu-thumb6.png" alt="Menu Thumbnail">
                            </div>
                            <div class="menu-content-wrap">
                                <div class="content">
                                    <h4 class="title"><a href="menu-details.html">Margarita Shrimp Tacos</a></h4>
                                    <p>Zesty shrimp tacos with fresh margarita flavor.</p>
                                </div>
                                <div class="price-box">
                                    <p class="price">$25.50</p>
                                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="menu-item style-eight mb-30 wow fadeInUp">
                            <div class="menu-thumbmail">
                                <img src="assets/images/menu/menu-thumb7.png" alt="Menu Thumbnail">
                            </div>
                            <div class="menu-content-wrap">
                                <div class="content">
                                    <h4 class="title"><a href="menu-details.html">BBQ Bacon Burger</a></h4>
                                    <p>Juicy burger topped with BBQ sauce and bacon.</p>
                                </div>
                                <div class="price-box">
                                    <p class="price">$35</p>
                                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="menu-item style-eight mb-30 wow fadeInUp">
                            <div class="menu-thumbmail">
                                <img src="assets/images/menu/menu-thumb8.png" alt="Menu Thumbnail">
                            </div>
                            <div class="menu-content-wrap">
                                <div class="content">
                                    <h4 class="title"><a href="menu-details.html">Spicy Tuna Roll</a></h4>
                                    <p>Spicy tuna roll with a bold, flavorful kick.</p>
                                </div>
                                <div class="price-box">
                                    <p class="price">$39</p>
                                </div>
